...
public class LogIn implements Initializable {
    ...
    void pasarPantalla(MouseEvent event) throws IOException {
        ...
        try {
            ...
            JsonNode jsonNode = objectMapper.readTree(informationstring.toString());
            
            pass = jsonNode.get("txto_psswrd").asText();
        ...
        if (getSHA256Hash(contraseñaPerfil.getText()).equals(pass)) {
            ...
            Primary protonmail = loader.getController();
            String prot=protonmailPerfil.getText();
            protonmail.setProtonmail(prot);
